...
PI2_IP = 1e-2/pressure_;                %PI2 at the boundary between the I and P region (p = [Ii']). Estimate from conductivity measurements assuming mobility for n and p of 10 cm^2 V^-1 s^-1 and for ion 1e-9 cm^2 V^-1 s^-1
